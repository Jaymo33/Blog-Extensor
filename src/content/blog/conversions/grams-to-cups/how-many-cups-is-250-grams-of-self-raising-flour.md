...
canonical: "https://www.airfryerrecipe.co.uk/blog/conversions/grams-to-cups/how-many-cups-is-250-grams-of-self-raising-flour"
schema: |
  <!-- Schema will be generated automatically -->
faqQ1: "Does 250g of self-raising flour equal 2 cups?"
faqA1: "In US measurements, yes - 250g of self-raising flour equals exactly 2 cups (using 240ml cups). However, in UK measurements where cups are 250ml, you'll need slightly less - about 1.92 cups. The difference comes from varying cup sizes between countries."
faqQ2: "How should I measure 250g of self-raising flour without scales?"
faqA2: "For the most accurate cup measurement without scales, fluff the flour with a fork first, then gently spoon it into your measuring cup. Level off the top with a straight edge. Never scoop directly from the bag as this compacts the flour. 250g equals about 2 lightly packed US cups or 1.92 UK cups."
faqQ3: "Why does my air fryer bake differently with 250g self-raising flour?"
faqA3: "Air fryers circulate hot air intensely, which can affect how self-raising flour behaves. The 250g measurement remains the same, but you may need to reduce temperature by 20°C versus oven recipes. Also check doneness earlier, as air fryers cook faster than conventional ovens."
faqQ4: "Can I use plain flour instead of self-raising flour for 250g measurements?"
faqA4: "You can substitute plain flour, but must add 2 teaspoons of baking powder per 250g to match self-raising flour's properties. The volume measurement stays the same (1.92 UK cups/2 US cups), but the chemical composition changes, requiring added leavening agents for proper rise in air fryer baking."
---
