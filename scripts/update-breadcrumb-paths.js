...
/**
 * Update breadcrumb paths to show the new nested structure
...
console.log('🔄 Updating breadcrumb paths to show nested structure...');
...
/**
 * Generate complete breadcrumb schema
 */
  ...
  try {
    ...
    if (breadcrumbStartRegex.test(content)) {
      ...
      if (startMatch) {
        ...
        const endMatch = remainingContent.match(breadcrumbEndRegex);
...
console.log(`\n✅ Breadcrumb path update complete:`);
